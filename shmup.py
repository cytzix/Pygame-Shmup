...
# connects to correct path on different computers to retrieve content from img folder
...
class Player(pygame.sprite.Sprite):
    ...
    def update(self):
        self.speedx = 0
        # get_pressed() returnes a list of key events
...
# Generate mobs and add them to the mob sprite group so they can be drawn
for i in range(8):
    m = Mob()
    all_sprites.add(m)
    mobs.add(m)
